...
public class animal {
	...
	public static void userActions() throws IOException, SQLException {
	...
	public static void managerActions() throws IOException, SQLException {
	...
	public static void setNameA(String n) throws IOException {
		nameA = n;
	}
	public static String getNameA() {
		return nameA;
	}
	public static void setInformationA(String infoA) throws IOException {
		informationA = infoA;
	}
